...
GLOBAL_COOLDOWN_DEFAULT = 30

USER_COOLDOWN_MIN = 10
USER_COOLDOWN_MAX = 2880
USER_COOLDOWN_DEFAULT = 120
...
LEGACY_DEFAULTS: Dict[str, Set[Any]] = {
    "global_cooldown_minutes": {45, 90},
    "user_cooldown_minutes": {180, 720},
    "max_message_length": {200},
    "reply_window_hours": {6},
    "urge_refill_hours": {8},
    "recent_talk_minutes": {45},
}
...
class SocialConfig:
    ...
    # 悬空对话：刚聊到一半对方没声了，问一句还在不在。这不等念头攒满
